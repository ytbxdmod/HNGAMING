...
spawn(function() 
    ...
    wait(1.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>HN GAMING chào ae<Color=/>"):Display()
    wait(.5)
...
local Window = OrionLib:MakeWindow({Name = "HN GAMING", HidePremium = false, IntroText = "HN GAMING⚜️", SaveConfig = true, ConfigFolder = "NightHub"})
...
W:AddLabel("HN GAMING SCRIPT")
W:AddLabel("DiscordHN GAMING")
local Section = W:AddSection({
    Name = "Status"
})
